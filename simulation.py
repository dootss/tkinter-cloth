...
class Cloth:
  def __init__(self, size=15, l=8, tear=120, offset=(0,0), screen_size=(700, 700)):
    global screen_w, screen_h
    screen_w, screen_h = screen_size
    
    self.points = [[Point(x*l+offset[0],y*l+offset[1]) for x in range(size*2)] for y in range(size)]
  ...
  def start_drag(self, pos, drag_radius=10):
